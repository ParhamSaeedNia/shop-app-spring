package org.example.shopapp.order.service;
...
import org.example.shopapp.common.entity.*;
import org.example.shopapp.common.exception.CartNotFoundException;
import org.example.shopapp.common.exception.OrderNotFoundException;
import org.example.shopapp.order.repository.OrderRepository;
import org.example.shopapp.order.repository.PaymentRepository;
import org.example.shopapp.order.repository.ShipmentRepository;
...
public class OrderService {
    ...
    private OrderResponse mapToOrderResponse(Order order) {
        List<org.example.shopapp.order.dto.response.OrderItemResponse> orderItemResponses = order.getOrderItems().stream()
    ...
    private org.example.shopapp.order.dto.response.OrderItemResponse mapToOrderItemResponse(OrderItem orderItem) {
        return org.example.shopapp.order.dto.response.OrderItemResponse.builder()
                .id(orderItem.getId())
    ...
    private org.example.shopapp.order.dto.response.PaymentResponse mapToPaymentResponse(Payment payment) {
        if (payment == null) {
            return null;
        }
        
        return org.example.shopapp.order.dto.response.PaymentResponse.builder()
                .id(payment.getId())
    ...
    private org.example.shopapp.order.dto.response.ShipmentResponse mapToShipmentResponse(Shipment shipment) {
        if (shipment == null) {
            return null;
        }
        
        return org.example.shopapp.order.dto.response.ShipmentResponse.builder()
                .id(shipment.getId())
